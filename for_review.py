...
try:
    ...
    #
    input1 = browser.find_element_by_css_selector("div[class='form-group first_class'] input[placeholder='Input your first name']")
    input1.send_keys("1")
    ...
    input4.send_keys("4")
    input5 = browser.find_element_by_css_selector("div[class='form-group second_class'] input[placeholder='Input your address:']")
    input5.send_keys("5")
    time.sleep(3)
